...
class T_VIEW_EXPORT fueltype_indexView : public TActionView
{
  Q_OBJECT
public:
  fueltype_indexView() : TActionView() { }
  QString toString();
};

QString fueltype_indexView::toString()
{
  responsebody.reserve(5171);
    tfetch(QString, notice);
  responsebody += QStringLiteral("<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <div class=\"panel panel-primary\">\n        <div class=\"panel-heading\">\n          <h3 class=\"panel-title\">\n            <a href=\"/admin/fuel/create\" class=\"btn-circle btn-circle-raised btn-circle-danger float-right\">\n              <i class=\"fa fa-plus\" style=\"margin-left: 10px\"></i>\n            </a>\n            <i class=\"fa fa-globe\"></i> Fuel Management\n          </h3>\n        </div>\n        <div class=\"panel-body\">\n          ");
...
T_DEFINE_VIEW(fueltype_indexView)

#include "fueltype_indexView.moc"

...
class T_VIEW_EXPORT partial_make_filterView : public TActionView
{
  Q_OBJECT
public:
  partial_make_filterView() : TActionView() { }
  QString toString();
};

QString partial_make_filterView::toString()
{
...
T_DEFINE_VIEW(partial_make_filterView)

#include "partial_make_filterView.moc"

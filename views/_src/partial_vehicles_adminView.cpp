...
class T_VIEW_EXPORT partial_vehicles_adminView : public TActionView
{
  Q_OBJECT
public:
  partial_vehicles_adminView() : TActionView() { }
  QString toString();
};
...
T_DEFINE_VIEW(partial_vehicles_adminView)

#include "partial_vehicles_adminView.moc"

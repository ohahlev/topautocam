...
HEADERS += backendcontroller.h
SOURCES += backendcontroller.cpp
HEADERS += frontendcontroller.h
SOURCES += frontendcontroller.cpp
HEADERS += homecontroller.h
SOURCES += homecontroller.cpp
HEADERS += publicvehiclecontroller.h
SOURCES += publicvehiclecontroller.cpp
